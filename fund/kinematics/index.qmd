...
- BOB the block has 6DOF
- each DOF may be constrained passively by a guide *or* actively with actuation, normally through a transmission 

## Exact Constraint 

- over constraining any DOF will lead to 'binding' where competing constraints disagree, e.g. two parallel rails are never truly parallel... 
- under constraining a DOF leads to backlash, 
